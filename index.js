...
const token = 'NzYzNjkzNjM1MTY5NjgxNDE4.X37bHw.rPgB_tjR5XLXzO8XTm9IxHH6_sY';
...
client.on('ready', () => {
    ...
    setInterval(() => {
        ...
        if ((date.getHours() === 08 && date.getMinutes() === 35) && date.getDay() != 0 && date.getDay() != 1 && date.getDay() != 5 && date.getDay() != 6) { // Diferente de domingo, segunda, sexta e sabado
            ...
            client.channels.fetch("753276752192602264").then(channel => { // CANAL PRIORIDADES DIÁRIAS LAB1 SERVER
